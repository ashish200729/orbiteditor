...
export class TestNativeHostService implements INativeHostService {
	...
	async invalidateWindow(options?: INativeHostOptions): Promise<void> { }
	async showAuxiliaryWindow(options?: INativeHostOptions): Promise<void> { }
	...
	async openUrlWithDevTools(url: string): Promise<void> { }
